...
data.innerHTML = `Currently, we have ${countries_data.length} counteries`
...
var tenPopulation = document.getElementById("topTen")
...
function populationCal(){
    ...
    for(let i=0;i<10;i++){
        ...
        var answer = document.getElementById("graph")
